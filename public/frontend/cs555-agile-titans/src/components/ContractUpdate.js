...
const ContractUpdate = () => {
  ...
  const updateContract = () => {
    ...
    fetchSomething(
      `api/contract/update/${contractNo}`,
      requestOptions,
      (res) => {
        console.log(res);
        setJump(true);
              ...
              <div className="mb-3 row">
                <div className="col-sm-3">
                  ...
                  <input
                    ...
                    id="dateSigned"
                    ref={dateSignedRef}
                    defaultValue={contractContent.dateSigned}
                  />
                </div>
              ...
              <div className="mb-3 row">
                <div className="col-sm-3">
                  ...
                  <input
                    ...
                    id="secondPartyName"
                    ref={secondPartyRef}
                    value={contractContent.secondParty}
                    readOnly
                  />
                </div>
            ...
            <div className="mb-3 row">
              ...
              <div className="col-sm-2">
                ...
                <input
                  ...
                  defaultValue={contractContent.paymentAmount}
                />
              </div>
              <div className="col-sm-5">
            ...
            <div className="mb-3 row">
              ...
              <div className="col-sm-3">
                ...
                <input
                  ...
                  id="noticePeriod"
                  ref={noticePeriodRef}
                  defaultValue={contractContent.noticePeriod}
                />
              </div>
              <div className="col-sm-5">
              ...
              <div className="mb-3 row">
                ...
                <div className="col-sm-3">
                  ...
                  <input
                    ...
                    id="startDate"
                    ref={startDateRef}
                    defaultValue={contractContent.startDate}
                  />
                </div>
              ...
              <div className="mb-3 row">
                <div className="col-sm-3">
                  ...
                  <input
                    ...
                    id="endDate"
                    ref={endDateRef}
                    defaultValue={contractContent.endDate}
                  />
                </div>
                <div className="col-sm-9">
